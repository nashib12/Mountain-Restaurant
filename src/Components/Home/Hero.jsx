        ...
        <div className='absolute inset-0 md:max-w-7xl mx-auto px-6 md:px-16 flex flex-col items-center mt-40 md:mt-48 '>
            ...
            <div className='bg-white grid w-full md:grid-cols-5 gap-4 px-8 py-8 mt-36 md:mt-16'>
                <div className='flex flex-col gap-2'>
                 ...
                 <div className='flex flex-col gap-2'>
                    <p className='uppercase md:text-lg'>Check-out *</p>
                    <button className='flex bg-gray-100 px-4 py-2 justify-between items-center h-8 md:h-16 '><span>Check-out Date</span><BiCalendar size={28} /></button>
                </div>
                 <div className='flex flex-col gap-2'>
                    <p className='uppercase md:text-lg'>Adults</p>
                    <button className='flex bg-gray-100 px-4 py-2 justify-between items-center h-8 md:h-16 '><span>1</span><RiArrowDropDownLine size={32} /></button>
                </div>
                 <div className='flex flex-col gap-2'>
                    <p className='uppercase md:text-lg'>Children</p>
                    <button className='flex bg-gray-100 px-4 py-2 justify-between items-center h-8 md:h-16'><span>1</span><RiArrowDropDownLine size={32} /></button>
                </div>
                <div className='flex flex-col-reverse gap-2'>
                    <button className='text-center px-4 py-2  h-8 md:h-16 uppercase text-white bg-[#C97A4F] hover:bg-black/90 cursor-pointer'>Check Availability</button>
                </div>
            </div>
        </div>
      </div>
